...
mod app {
    ...
    use embedded_graphics::mono_font::{iso_8859_13::FONT_10X20, iso_8859_2::FONT_6X13};
    ...
    fn init(cx: init::Context) -> (Shared, Local, init::Monotonics) {
        ...
        // Connect SDA to P0.5 and SCL to pin P0.4
        let port0 = p0::Parts::new(cx.device.P0);

        let scl = port0.p0_04.into_floating_input().degrade();
        let sda = port0.p0_05.into_floating_input().degrade();
