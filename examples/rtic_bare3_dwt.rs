//! rtic_bare3_dwt.rs
//!
//! `DwtSystick` a DWT based `Monotonic` timer with less
//! CPU overhead than the `Systick` implementation.
#![no_main]
#![no_std]
...
mod app {
    ...
    type MyMono = DwtSystick<FREQ_CORE>; // 64MHz cycle accurate accuracy
